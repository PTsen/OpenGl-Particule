...
void MyApplication::update(int elapsedTime)
{
    ...
    modelMatrix = modelMatrix*scale(30.f,10.f,10.f);
...
//prems arg c 'est l angle de camera
    mat4 projectionMatrix = perspective(10.0f, 640.0f/480, 0.001f, 100.0f);

// position de la camera sur un point 
    mat4 viewMatrix = lookat(vec3(15, 15, 15), vec3(0, 1, 0), vec3(0, 1, 0));
    mat4 modelMatrix = rotate(angle, 0.0f, 1.0f, 0.0f);
    ...
    dragon = Mesh::fromOBJ("models/i.obj");
